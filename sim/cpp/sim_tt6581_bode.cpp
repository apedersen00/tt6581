...
int main(int argc, char** argv) {
    ...
    // Let the envelope settle before sweeping
    ...
    // Stepped frequency sweep: dwell at each frequency for CYCLES_PER_STEP cycles
    for (int step = 0; step < NUM_STEPS; step++) {
        ...
        // Dwell for the requested number of waveform cycles
